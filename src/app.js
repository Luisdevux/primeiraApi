...
import DbConect from './config/DbConnect';
...
app.use((req, res, next) => {
    return CommonResponse/*(Tem que importar)*/.error(
        res,
        404,
        'resourceNotFound',
        null,
...
//     logger(Tem que importar).error('Unhandled Rejection at:', promise, 'reason:', reason);
...
// app.use(errorHandler(Tem que importar));
